	...
	testcases := []testCase{
		{
			...
			expectedImportBasePath:  "github.com/tediousdynam/pulumi-terraform-module/sdks/go/consul/consul",
		},
		{
		...
		},
		{
			...
			expectedImportBasePath:  "github.com/tediousdynam/pulumi-terraform-module/sdks/go/bucket/v4/bucket",
