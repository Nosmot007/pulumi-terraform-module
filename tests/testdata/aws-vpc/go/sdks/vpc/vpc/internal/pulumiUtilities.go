...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^github.com/tediousdynam/pulumi-terraform-module/sdks/vpc(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("ewogICJtb2R1bGUiOiAidGVycmFmb3JtLWF3cy1tb2R1bGVzL3ZwYy9hd3MiLAogICJ2ZXJzaW9uIjogIjUuMTguMSIsCiAgInBhY2thZ2VOYW1lIjogInZwYyIKfQ==")
		if err != nil {
			return "", err
		}
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	version := semver.MustParse("5.18.1")
