...
import (
	...
	"github.com/tediousdynam/pulumi-terraform-module/sdks/vpc/internal"
...
func NewModule(ctx *pulumi.Context,
	...
	var resource Module
	err = ctx.RegisterPackageRemoteComponentResource("vpc:index:Module", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type moduleArgs struct {
	...
	Customer_gateways map[string]map[string]interface{} `pulumi:"customer_gateways"`
...
type ModuleArgs struct {
	...
	// Maps of Customer Gateway's attributes (BGP ASN and Gateway's Internet-routable external IP address)
	Customer_gateways pulumi.MapMapInput
	// The customer owned IPv4 address pool. Typically used with the `map_customer_owned_ip_on_launch` argument. The `outpost_arn` argument must be specified when configured
...
// A list of availability zones specified as argument to this module
func (o ModuleOutput) Azs() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Azs }).(pulumi.StringArrayOutput)
}

// List of ARNs of Customer Gateway
func (o ModuleOutput) Cgw_arns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Cgw_arns }).(pulumi.StringArrayOutput)
}

// List of IDs of Customer Gateway
func (o ModuleOutput) Cgw_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Cgw_ids }).(pulumi.StringArrayOutput)
}

// ID of the database internet gateway route
func (o ModuleOutput) Database_internet_gateway_route_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Database_internet_gateway_route_id }).(pulumi.StringPtrOutput)
}

// ID of the database IPv6 egress route
func (o ModuleOutput) Database_ipv6_egress_route_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Database_ipv6_egress_route_id }).(pulumi.StringPtrOutput)
}

// List of IDs of the database nat gateway route
func (o ModuleOutput) Database_nat_gateway_route_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Database_nat_gateway_route_ids }).(pulumi.StringArrayOutput)
}

// ARN of the database network ACL
func (o ModuleOutput) Database_network_acl_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Database_network_acl_arn }).(pulumi.StringPtrOutput)
}

// ID of the database network ACL
func (o ModuleOutput) Database_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Database_network_acl_id }).(pulumi.StringPtrOutput)
}

// List of IDs of the database route table association
func (o ModuleOutput) Database_route_table_association_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Database_route_table_association_ids }).(pulumi.StringArrayOutput)
}

// List of IDs of database route tables
func (o ModuleOutput) Database_route_table_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Database_route_table_ids }).(pulumi.StringArrayOutput)
}

// List of ARNs of database subnets
func (o ModuleOutput) Database_subnet_arns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Database_subnet_arns }).(pulumi.StringArrayOutput)
}

// ID of database subnet group
func (o ModuleOutput) Database_subnet_group() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Database_subnet_group }).(pulumi.StringPtrOutput)
}

// Name of database subnet group
func (o ModuleOutput) Database_subnet_group_name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Database_subnet_group_name }).(pulumi.StringPtrOutput)
}
...
// List of IDs of database subnets
func (o ModuleOutput) Database_subnets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Database_subnets }).(pulumi.StringArrayOutput)
}

// List of cidr_blocks of database subnets
func (o ModuleOutput) Database_subnets_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Database_subnets_cidr_blocks }).(pulumi.StringArrayOutput)
}

// List of IPv6 cidr_blocks of database subnets in an IPv6 enabled VPC
func (o ModuleOutput) Database_subnets_ipv6_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Database_subnets_ipv6_cidr_blocks }).(pulumi.StringArrayOutput)
}

// The ID of the default network ACL
func (o ModuleOutput) Default_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_network_acl_id }).(pulumi.StringPtrOutput)
}

// The ID of the default route table
func (o ModuleOutput) Default_route_table_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_route_table_id }).(pulumi.StringPtrOutput)
}

// The ID of the security group created by default on VPC creation
func (o ModuleOutput) Default_security_group_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_security_group_id }).(pulumi.StringPtrOutput)
}

// The ARN of the Default VPC
func (o ModuleOutput) Default_vpc_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_vpc_arn }).(pulumi.StringPtrOutput)
}

// The CIDR block of the Default VPC
func (o ModuleOutput) Default_vpc_cidr_block() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_vpc_cidr_block }).(pulumi.StringPtrOutput)
}

// The ID of the default network ACL of the Default VPC
func (o ModuleOutput) Default_vpc_default_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_vpc_default_network_acl_id }).(pulumi.StringPtrOutput)
}

// The ID of the default route table of the Default VPC
func (o ModuleOutput) Default_vpc_default_route_table_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_vpc_default_route_table_id }).(pulumi.StringPtrOutput)
}

// The ID of the security group created by default on Default VPC creation
func (o ModuleOutput) Default_vpc_default_security_group_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_vpc_default_security_group_id }).(pulumi.StringPtrOutput)
}
...
// The ID of the Default VPC
func (o ModuleOutput) Default_vpc_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_vpc_id }).(pulumi.StringPtrOutput)
}

// Tenancy of instances spin up within Default VPC
func (o ModuleOutput) Default_vpc_instance_tenancy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_vpc_instance_tenancy }).(pulumi.StringPtrOutput)
}

// The ID of the main route table associated with the Default VPC
func (o ModuleOutput) Default_vpc_main_route_table_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Default_vpc_main_route_table_id }).(pulumi.StringPtrOutput)
}

// The ID of the DHCP options
func (o ModuleOutput) Dhcp_options_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Dhcp_options_id }).(pulumi.StringPtrOutput)
}

// The ID of the egress only Internet Gateway
func (o ModuleOutput) Egress_only_internet_gateway_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Egress_only_internet_gateway_id }).(pulumi.StringPtrOutput)
}

// ARN of the elasticache network ACL
func (o ModuleOutput) Elasticache_network_acl_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Elasticache_network_acl_arn }).(pulumi.StringPtrOutput)
}

// ID of the elasticache network ACL
func (o ModuleOutput) Elasticache_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Elasticache_network_acl_id }).(pulumi.StringPtrOutput)
}

// List of IDs of the elasticache route table association
func (o ModuleOutput) Elasticache_route_table_association_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Elasticache_route_table_association_ids }).(pulumi.StringArrayOutput)
}
...
// List of ARNs of elasticache subnets
func (o ModuleOutput) Elasticache_subnet_arns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Elasticache_subnet_arns }).(pulumi.StringArrayOutput)
}

// ID of elasticache subnet group
func (o ModuleOutput) Elasticache_subnet_group() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Elasticache_subnet_group }).(pulumi.StringPtrOutput)
}

// Name of elasticache subnet group
func (o ModuleOutput) Elasticache_subnet_group_name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Elasticache_subnet_group_name }).(pulumi.StringPtrOutput)
}
...
// List of IDs of elasticache subnets
func (o ModuleOutput) Elasticache_subnets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Elasticache_subnets }).(pulumi.StringArrayOutput)
}

// List of cidr_blocks of elasticache subnets
func (o ModuleOutput) Elasticache_subnets_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Elasticache_subnets_cidr_blocks }).(pulumi.StringArrayOutput)
}

// List of IPv6 cidr_blocks of elasticache subnets in an IPv6 enabled VPC
func (o ModuleOutput) Elasticache_subnets_ipv6_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Elasticache_subnets_ipv6_cidr_blocks }).(pulumi.StringArrayOutput)
}

// The ARN of the Internet Gateway
func (o ModuleOutput) Igw_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Igw_arn }).(pulumi.StringPtrOutput)
}

// The ID of the Internet Gateway
func (o ModuleOutput) Igw_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Igw_id }).(pulumi.StringPtrOutput)
}

// ARN of the intra network ACL
func (o ModuleOutput) Intra_network_acl_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Intra_network_acl_arn }).(pulumi.StringPtrOutput)
}

// ID of the intra network ACL
func (o ModuleOutput) Intra_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Intra_network_acl_id }).(pulumi.StringPtrOutput)
}

// List of IDs of the intra route table association
func (o ModuleOutput) Intra_route_table_association_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Intra_route_table_association_ids }).(pulumi.StringArrayOutput)
}

// List of IDs of intra route tables
func (o ModuleOutput) Intra_route_table_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Intra_route_table_ids }).(pulumi.StringArrayOutput)
}

// List of ARNs of intra subnets
func (o ModuleOutput) Intra_subnet_arns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Intra_subnet_arns }).(pulumi.StringArrayOutput)
}
...
// List of IDs of intra subnets
func (o ModuleOutput) Intra_subnets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Intra_subnets }).(pulumi.StringArrayOutput)
}

// List of cidr_blocks of intra subnets
func (o ModuleOutput) Intra_subnets_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Intra_subnets_cidr_blocks }).(pulumi.StringArrayOutput)
}

// List of IPv6 cidr_blocks of intra subnets in an IPv6 enabled VPC
func (o ModuleOutput) Intra_subnets_ipv6_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Intra_subnets_ipv6_cidr_blocks }).(pulumi.StringArrayOutput)
}

// The name of the VPC specified as argument to this module
func (o ModuleOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Name }).(pulumi.StringPtrOutput)
}

// List of allocation ID of Elastic IPs created for AWS NAT Gateway
func (o ModuleOutput) Nat_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Nat_ids }).(pulumi.StringArrayOutput)
}
...
// List of NAT Gateway IDs
func (o ModuleOutput) Natgw_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Natgw_ids }).(pulumi.StringArrayOutput)
}

// List of Network Interface IDs assigned to NAT Gateways
func (o ModuleOutput) Natgw_interface_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Natgw_interface_ids }).(pulumi.StringArrayOutput)
}

// ARN of the outpost network ACL
func (o ModuleOutput) Outpost_network_acl_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Outpost_network_acl_arn }).(pulumi.StringPtrOutput)
}

// ID of the outpost network ACL
func (o ModuleOutput) Outpost_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Outpost_network_acl_id }).(pulumi.StringPtrOutput)
}

// List of ARNs of outpost subnets
func (o ModuleOutput) Outpost_subnet_arns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Outpost_subnet_arns }).(pulumi.StringArrayOutput)
}
...
// List of IDs of outpost subnets
func (o ModuleOutput) Outpost_subnets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Outpost_subnets }).(pulumi.StringArrayOutput)
}

// List of cidr_blocks of outpost subnets
func (o ModuleOutput) Outpost_subnets_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Outpost_subnets_cidr_blocks }).(pulumi.StringArrayOutput)
}

// List of IPv6 cidr_blocks of outpost subnets in an IPv6 enabled VPC
func (o ModuleOutput) Outpost_subnets_ipv6_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Outpost_subnets_ipv6_cidr_blocks }).(pulumi.StringArrayOutput)
}

// List of IDs of the ipv6 egress route
func (o ModuleOutput) Private_ipv6_egress_route_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Private_ipv6_egress_route_ids }).(pulumi.StringArrayOutput)
}

// List of IDs of the private nat gateway route
func (o ModuleOutput) Private_nat_gateway_route_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Private_nat_gateway_route_ids }).(pulumi.StringArrayOutput)
}

// ARN of the private network ACL
func (o ModuleOutput) Private_network_acl_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Private_network_acl_arn }).(pulumi.StringPtrOutput)
}

// ID of the private network ACL
func (o ModuleOutput) Private_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Private_network_acl_id }).(pulumi.StringPtrOutput)
}

// List of IDs of the private route table association
func (o ModuleOutput) Private_route_table_association_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Private_route_table_association_ids }).(pulumi.StringArrayOutput)
}
...
// List of ARNs of private subnets
func (o ModuleOutput) Private_subnet_arns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Private_subnet_arns }).(pulumi.StringArrayOutput)
}
...
// List of IDs of private subnets
func (o ModuleOutput) Private_subnets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Private_subnets }).(pulumi.StringArrayOutput)
}

// List of cidr_blocks of private subnets
func (o ModuleOutput) Private_subnets_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Private_subnets_cidr_blocks }).(pulumi.StringArrayOutput)
}

// List of IPv6 cidr_blocks of private subnets in an IPv6 enabled VPC
func (o ModuleOutput) Private_subnets_ipv6_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Private_subnets_ipv6_cidr_blocks }).(pulumi.StringArrayOutput)
}

// ID of the IPv6 internet gateway route
func (o ModuleOutput) Public_internet_gateway_ipv6_route_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Public_internet_gateway_ipv6_route_id }).(pulumi.StringPtrOutput)
}

// ID of the internet gateway route
func (o ModuleOutput) Public_internet_gateway_route_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Public_internet_gateway_route_id }).(pulumi.StringPtrOutput)
}

// ARN of the public network ACL
func (o ModuleOutput) Public_network_acl_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Public_network_acl_arn }).(pulumi.StringPtrOutput)
}

// ID of the public network ACL
func (o ModuleOutput) Public_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Public_network_acl_id }).(pulumi.StringPtrOutput)
}

// List of IDs of the public route table association
func (o ModuleOutput) Public_route_table_association_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Public_route_table_association_ids }).(pulumi.StringArrayOutput)
}
...
// List of ARNs of public subnets
func (o ModuleOutput) Public_subnet_arns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Public_subnet_arns }).(pulumi.StringArrayOutput)
}
...
// List of IDs of public subnets
func (o ModuleOutput) Public_subnets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Public_subnets }).(pulumi.StringArrayOutput)
}

// List of cidr_blocks of public subnets
func (o ModuleOutput) Public_subnets_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Public_subnets_cidr_blocks }).(pulumi.StringArrayOutput)
}

// List of IPv6 cidr_blocks of public subnets in an IPv6 enabled VPC
func (o ModuleOutput) Public_subnets_ipv6_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Public_subnets_ipv6_cidr_blocks }).(pulumi.StringArrayOutput)
}

// ARN of the redshift network ACL
func (o ModuleOutput) Redshift_network_acl_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Redshift_network_acl_arn }).(pulumi.StringPtrOutput)
}

// ID of the redshift network ACL
func (o ModuleOutput) Redshift_network_acl_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Redshift_network_acl_id }).(pulumi.StringPtrOutput)
}

// List of IDs of the public redshift route table association
func (o ModuleOutput) Redshift_public_route_table_association_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Redshift_public_route_table_association_ids }).(pulumi.StringArrayOutput)
}

// List of IDs of the redshift route table association
func (o ModuleOutput) Redshift_route_table_association_ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Redshift_route_table_association_ids }).(pulumi.StringArrayOutput)
}
...
// List of ARNs of redshift subnets
func (o ModuleOutput) Redshift_subnet_arns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Redshift_subnet_arns }).(pulumi.StringArrayOutput)
}

// ID of redshift subnet group
func (o ModuleOutput) Redshift_subnet_group() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Redshift_subnet_group }).(pulumi.StringPtrOutput)
}
...
// List of IDs of redshift subnets
func (o ModuleOutput) Redshift_subnets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Redshift_subnets }).(pulumi.StringArrayOutput)
}

// List of cidr_blocks of redshift subnets
func (o ModuleOutput) Redshift_subnets_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Redshift_subnets_cidr_blocks }).(pulumi.StringArrayOutput)
}

// List of IPv6 cidr_blocks of redshift subnets in an IPv6 enabled VPC
func (o ModuleOutput) Redshift_subnets_ipv6_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Redshift_subnets_ipv6_cidr_blocks }).(pulumi.StringArrayOutput)
}
...
// The ARN of the VPN Gateway
func (o ModuleOutput) Vgw_arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vgw_arn }).(pulumi.StringPtrOutput)
}

// The ID of the VPN Gateway
func (o ModuleOutput) Vgw_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vgw_id }).(pulumi.StringPtrOutput)
}

// The ARN of the VPC
func (o ModuleOutput) Vpc_arn() pulumi.StringPtrOutput {
...
// The ARN of the IAM role used when pushing logs cross account
func (o ModuleOutput) Vpc_flow_log_deliver_cross_account_role() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_flow_log_deliver_cross_account_role }).(pulumi.StringPtrOutput)
}
...
// The type of the destination for VPC Flow Logs
func (o ModuleOutput) Vpc_flow_log_destination_type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_flow_log_destination_type }).(pulumi.StringPtrOutput)
}

// The ID of the Flow Log resource
func (o ModuleOutput) Vpc_flow_log_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_flow_log_id }).(pulumi.StringPtrOutput)
}

// The ID of the VPC
func (o ModuleOutput) Vpc_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_id }).(pulumi.StringPtrOutput)
}

// Tenancy of instances spin up within VPC
func (o ModuleOutput) Vpc_instance_tenancy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_instance_tenancy }).(pulumi.StringPtrOutput)
}

// The association ID for the IPv6 CIDR block
func (o ModuleOutput) Vpc_ipv6_association_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_ipv6_association_id }).(pulumi.StringPtrOutput)
}

// The IPv6 CIDR block
func (o ModuleOutput) Vpc_ipv6_cidr_block() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_ipv6_cidr_block }).(pulumi.StringPtrOutput)
}

// The ID of the main route table associated with this VPC
func (o ModuleOutput) Vpc_main_route_table_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_main_route_table_id }).(pulumi.StringPtrOutput)
}

// The ID of the AWS account that owns the VPC
func (o ModuleOutput) Vpc_owner_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Module) pulumi.StringPtrOutput { return v.Vpc_owner_id }).(pulumi.StringPtrOutput)
}

// List of secondary CIDR blocks of the VPC
func (o ModuleOutput) Vpc_secondary_cidr_blocks() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Module) pulumi.StringArrayOutput { return v.Vpc_secondary_cidr_blocks }).(pulumi.StringArrayOutput)
}
